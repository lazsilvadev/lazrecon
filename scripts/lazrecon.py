...
# ESTA É A SOLUÇÃO PARA O ÍCONE NA BARRA DE TAREFAS DO WINDOWS
...
def main(page: ft.Page):
    ...
    page.window.maximizable = False  # Desativa o botão de maximizar2020

    # 3. Centraliza a janela ao abrir (Opcional, mas recomendado)
    ...
    ft.Text(
                    "⚠️ Use com responsabilidade em sistemas autorizados.", # Alerta de uso responsável
...
if __name__ == "__main__":
    # Crie uma pasta chamada 'assets' e coloque o icon.ico dentro dela
